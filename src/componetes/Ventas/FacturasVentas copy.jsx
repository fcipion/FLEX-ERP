...
const FacturasVentas = () => {
    ...
    switch (modo) {
        case 'create':
            ...
            break;
        case 'edit':
            formTitulo = 'Editar factura';
            break;

        case 'view':
            formTitulo = 'Visualizar factura';
            break;
        default:
            formTitulo = 'Registro de factura';
            break;
    }
            ...
            >
                <Formik
                    ...
                    initialValues={{
                        ...
                        subTotal: venta.data ? venta.data.subTotal : '',
                        total: venta.data ? venta.data.total : '',
