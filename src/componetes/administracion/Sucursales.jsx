...
const Sucursales = () => {
    ...
    const { sucursales, sucursal, error } = useSelector((state) => state.sucursal);
    ...
    return modo === 'Index' ? (
        <>
            {console.log('sucursal', sucursales)}
            {sucursales.length !== 0 ? (
                <MainCard title="Listado de sucursal">
                    <QuickFilteringGrid data={sucursales} clickAdd={handlerAdd} clickEdit={clickEdit} clickView={clickView} />
                </MainCard>
            ) : (
                <LineProgress />
            )}
                    ...
                    onSubmit={(value, { setSubmitting, resetForm }) => {
                        setTimeout(async () => {
                            ...
                            try {
                                ...
                                setSubmitting(false);
                                setMessageInfo({ type: 'error', title: `Error creando sucursal: ${JSON.stringify(error)}` });
                            }
