...
import {
  getTipoDocumentos,
  getTipoDocumentosById,
} from "store/slices/tipoDocumento";
...
const TipoDocumentos = () => {
  ...
  const { tipoDocumentos, tipoDocumento, error } = useSelector(
      ...
      >
        <Formik
          ...
          initialValues={{
            ...
            descripcion: tipoDocumento.data
          ...
          onSubmit={(value, { setSubmitting, resetForm }) => {
            setTimeout(async () => {
              ...
              try {
                switch (modoAccion) {
                  ...
                  case "Editar":
                    result = await axios.put(
                      `${url}/actualizar_tipo_documento/${id}`,
                      value
                    );
                    if (!result.error) {
                  ...
                  case "delete":
                    result = await axios.delete(
                      `${url}/eliminar_tipo_documento/${id}`,
                      value
                    );
                ...
                setMessageInfo({
                  type: "error",
                  title: `Error creando Tipo de documento ${JSON.stringify(
                    error
                  )}`,
                });
              }
