...
const OrdenServicios = () => {
    ...
    switch (modo) {
        case 'create':
            formTitulo = 'Registro de orden de servicios';
            break;
        case 'edit':
            formTitulo = 'Editar orden de servicios';
            break;

        case 'view':
            formTitulo = 'Visualizar orden de servicios';
            break;
        default:
            formTitulo = 'Registro de orden de servicios';
            break;
