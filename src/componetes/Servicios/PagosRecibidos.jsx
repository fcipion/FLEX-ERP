...
import OrdenServicios from './OrdenServicios';
...
const PagosRecibidos = ({
    ...
    const camposRequeridos = (values) => {
        ...
        if (values.totalPendiente !== 0) {
            setCamposRequerdio((previewValue) => {
                previewValue.descripcion = 'Por favor pagar el total del documento';
                return previewValue;
            });
        }
    };
                                ...
                                AplicarPago={() => {
                                    ...
                                    if (camposRequerdioValue.descripcion !== '') {
                                        ...
                                        setFacturas((previewValue) => {
                                            previewValue.totalPendiente = 0;
                                            previewValue.estado = 'PAGO APLICADO';
                                            return previewValue;
                                        });
                                        setFieldValue('totalPendiente', 0);
                                        setFieldValue('estado', 'PAGO APLICADO');
                                        cancelar();
                                    }
                                }}
                                Cancelar={cancelar}
