...
import { getBancoById, getBancos } from 'store/slices/banco';
...
export default function DropBanco({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur, Onchange }) {
    ...
    if (bancos.rows) {
        bancos.rows.forEach((result, index) => {
            ...
            <Grid item xs={12}>
                <Autocomplete
                    ...
                    onChange={(event, value) => {
                        ...
                        // dispatch(getbancoById(value.value));
                    }}
                    renderInput={(params) => (
                        <TextField
                            {...params}
