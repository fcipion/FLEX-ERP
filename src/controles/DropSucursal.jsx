...
import Sucursal, {
  getSucursales,
  getSucursalById,
} from "store/slices/sucursal";
import Sucursales from "componetes/administracion/Sucursales";
...
export default function DropSucursal({
  ...
  const { sucursales, sucursale, error } = useSelector(
  ...
  if (sucursales.rows) {
    sucursales.rows.forEach((result, index) => {
