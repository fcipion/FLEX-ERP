...
import tasaCambio, { getTasaCambios, getTasaCambioById } from 'store/slices/tasaCambio';
import TasaCambios from 'componetes/Gestion/TasaCambios';
...
export default function DroptasaCambios({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur, Onchange }) {
    ...
    if (tasaCambios.rows) {
        tasaCambios.rows.forEach((result, index) => {
            /* eslint no-underscore-dangle: 0 */
            data[index] = { title: result.value_to, value: result._id };
        });
    }
