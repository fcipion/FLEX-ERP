...
// import claseReprComerciales from 'componetes/administracion/claseReprComerciales';
...
export default function DropTipoClientes({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur }) {
    ...
    if (claseReprComerciales.rows) {
        claseReprComerciales.rows.forEach((result, index) => {
                            ...
                            InputProps={{
                                ...
                                endAdornment: (
                                    <>
                                        ...
                                        <IconButton onClick={handleClickOpen} aria-label="Agregar">
                                            <AddCircleTwoToneIcon titleAccess="Agregar" fontSize="small" />
                                        </IconButton>
                                    </>
                                )
                            }}
