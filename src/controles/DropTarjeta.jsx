...
import { getTarjetaById, getTarjetas } from 'store/slices/tarjeta';
...
export default function DropTarjeta({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur, Onchange }) {
    ...
    if (tarjetas.rows) {
        tarjetas.rows.forEach((result, index) => {
            ...
            <Grid item xs={12}>
                <Autocomplete
                    ...
                    onChange={(event, value) => {
                        ...
                        // dispatch(gettarjetaById(value.value));
                    }}
                    renderInput={(params) => (
                        <TextField
                            {...params}
