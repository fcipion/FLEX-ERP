...
import { getAlmacenById, getAlmacens } from 'store/slices/almacen';
...
export default function DropAlmacen({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur, Onchange, Row }) {
    ...
    if (almacens.rows) {
        almacens.rows.forEach((result, index) => {
