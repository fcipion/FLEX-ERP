...
import TipoProductos from 'componetes/Gestion/TipoProductos';
...
export default function DropTipoProducto({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur }) {
    ...
    if (tipoProductos.rows) {
        tipoProductos.rows.forEach((result, index) => {
