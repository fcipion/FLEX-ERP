...
export default function DropClaseProducto({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur }) {
    ...
    if (claseProductos.rows) {
        claseProductos.rows.forEach((result, index) => {
