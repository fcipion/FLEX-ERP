...
// import terminoPagos from 'componetes/administracion/terminoPagos';
...
export default function DropTerminoPago({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur }) {
    ...
    if (terminoPagos.rows) {
        terminoPagos.rows.forEach((result, index) => {
