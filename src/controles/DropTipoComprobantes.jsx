...
import TipoComprobantes from 'componetes/Gestion/TipoComprobantes';
...
export default function DropTipoComprobantes({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur, Onchange, required }) {
