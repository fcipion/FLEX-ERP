...
export default function DropTipoDocumentos({ Id, SetFieldValue, Value, SetValue, Label, Errors, Touched, OnBlur }) {
    ...
    if (tipoDocumentos.rows) {
        tipoDocumentos.rows.forEach((result, index) => {
